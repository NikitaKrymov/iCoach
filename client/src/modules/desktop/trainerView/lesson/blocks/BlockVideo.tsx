...
const BlockVideo: React.FC = (props) => {
                ...
                <FlexBox theme={EDITMODE_CONTENT} style={{border: '1px solid grey'}}>
                    <FlexBox theme={ BLOCK_EDIT_OPTIONS } style={{ borderBottom: '1px solid grey', padding: '0.5em' }}>
                        <FlexBox theme={BLOCK_EDIT_OPTIONS_FLEX_START}>
                            <BlockOptionButton onClick={() => console.log('Select a new video file')}>
                                Select File
                            </BlockOptionButton>
                        </FlexBox>
                    ...
                    <FlexBox style={{ justifyContent: 'center', alignItems: 'center' }}>
                        <BlockImageContent src="https://image.similarpng.com/thumbnail/2020/08/Youtube-player-video-Preumim-vector-PNG.png" alt="Video" style={{ width: '50%'}} />
                    </FlexBox>
                </FlexBox>
