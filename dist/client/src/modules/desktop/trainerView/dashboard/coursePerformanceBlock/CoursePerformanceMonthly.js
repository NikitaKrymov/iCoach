...
var CoursePerformanceChartMonthly = function (props) {
        ...
        var chartConfig = {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        data: DateSortHelpers_1.renderMonthlySalesRevenue(props.sales)
                    }]
            },
            options: {
                legend: {
...
exports.default = CoursePerformanceChartMonthly;
